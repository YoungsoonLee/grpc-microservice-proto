...
go mod init github.com/YoungsoonLee/grpc-microservice/golang/${SERVICE_NAME} || true
go mod tidy
cd ../../
git config --global user.email "youngtip@gmail.com"
git config --global user.name "YoungsoonLee"
